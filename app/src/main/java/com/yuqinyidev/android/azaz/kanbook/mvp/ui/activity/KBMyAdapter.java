...
public class KBMyAdapter extends BaseAdapter {
    ...
    public KBMyAdapter(Context context, List<String> it, List<String> pa) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.kb_file_row, null);
