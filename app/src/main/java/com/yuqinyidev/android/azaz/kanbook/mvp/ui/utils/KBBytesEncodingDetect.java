...
public class KBBytesEncodingDetect extends KBEncoding {
    ...
    public static void main(String argc[]) {
        KBBytesEncodingDetect sinodetector;
        int result = OTHER;
        int i;
        sinodetector = new KBBytesEncodingDetect();
