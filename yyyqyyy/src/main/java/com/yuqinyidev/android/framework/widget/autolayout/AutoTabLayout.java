package com.yuqinyidev.android.framework.widget.autolayout;
...
public class AutoTabLayout extends TabLayout {
    ...
    private int loadTextSizeFromTextAppearance(int tabTextAppearance) {
        TypedArray a = getContext().obtainStyledAttributes(tabTextAppearance, R.styleable.TextAppearance);
    ...
    private void setUpTabTextSize(Tab tab) {
        ...
        textView.setTextSize(TypedValue.COMPLEX_UNIT_PT, autoTextSize);
    }
}
